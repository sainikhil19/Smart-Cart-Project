...
public class StationaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_cart=(Button)findViewById(R.id.add_stationary);
        add_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(StationaryActivity.this,"Added to Cart",Toast.LENGTH_SHORT).show();
                Intent i=new Intent(StationaryActivity.this,CartActivity.class);
                TextView tv=(TextView)findViewById(R.id.stationary_heading);
