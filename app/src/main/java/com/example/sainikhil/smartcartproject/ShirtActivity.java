...
public class ShirtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_cart=(Button)findViewById(R.id.add_shirt);
        add_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ShirtActivity.this,"Added to Cart",Toast.LENGTH_SHORT).show();
                Intent i=new Intent(ShirtActivity.this,CartActivity.class);
                TextView tv=(TextView)findViewById(R.id.shirt_title);
